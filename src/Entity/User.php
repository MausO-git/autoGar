...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\NotBlank(message:"Vous devez renseigner une image de profil")]
    #[Assert\File(maxSize:"2M", maxSizeMessage:"La taille du fichier est trop grande")]
    #[Assert\Image(mimeTypes:["image/jpeg", "image/jpg", "image/png"], mimeTypesMessage:"Le format de l'image n'est pas valide")]
    ...
    /**
     * Complète automatiquement le slug pour les nouveaux utilisateurs lors d'une inscription
     *
     * @return void
     */
    #[ORM\PrePersist]
    ...
    {
        $roles = $this->roles;
        //donne le rôle USER à tous les utilisatuers
        $roles[] = 'ROLE_USER';
